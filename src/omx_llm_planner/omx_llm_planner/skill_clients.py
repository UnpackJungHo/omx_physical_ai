...
각 action(/omx/pick_place, /omx/pick_place_all, /omx/move_to_named) 에 대해
...
from omx_interfaces.action import MoveToNamed, PickPlace, PickPlaceAll
...
class SkillDispatcher:
    def __init__(self, node: Node, cb_group, config: DispatcherConfig) -> None:
        self._node = node
        self._config = config
        self._clients = {
